...
function App() {
  ...
  useEffect(() => {
    // Set initial height for testimonials
  ...
  return (
    <>
      <header
        className={`header-area header-sticky wow slideInDown ${isHeaderFixed ? 'background-header' : ''}`}
              ...
              <nav className="main-nav">
                ...
                <ul className="nav" style={{ display: isMobileMenuOpen ? 'block' : '' }}>
                  <li className="scroll-to-section">
                    <a href="#top" className="active" onClick={(e) => scrollToSection(e, '#top')}>
                      Home
                    </a>
                  </li>
                  <li className="scroll-to-section">
                ...
                <a className={`menu-trigger ${isMobileMenuOpen ? 'active' : ''}`} onClick={() => setIsMobileMenuOpen(!isMobileMenuOpen)}>
                  <span>Menu</span>
                </a>
              </nav>
            </div>
        ...
        <section className="popupBody">
          <div className="social_login" style={{ display: modalView === 'social' ? 'block' : 'none' }}>
            ...
            <div className="action_btns">
              <div className="one_half">
                <a href="#" id="login_form" className="btn" onClick={(e) => { e.preventDefault(); setModalView('login'); }}>
                  Login
                </a>
              </div>
          ...
          <div className="user_login" style={{ display: modalView === 'login' ? 'block' : 'none' }}>
            <div>
              ...
              <div className="action_btns">
                <div className="one_half">
                  <a href="#" className="btn back_btn" onClick={(e) => { e.preventDefault(); setModalView('social'); }}>
                ...
                <div className="grid">
                  <div className="row">
                    <div className="col-lg-7 align-self-center">
                      <div className="menu">
                        <div className={activeTestimonial === 0 ? "first-thumb active" : "first-thumb"} onClick={() => handleTestimonialClick(0)}>
                          <div className="thumb">
                            <div className="row">
                        ...
                        <div className={activeTestimonial === 1 ? "active" : ""} onClick={() => handleTestimonialClick(1)}>
                          <div className="thumb">
                            <div className="row">
                              <div className="col-lg-4 col-sm-4 col-12">
                        ...
                        <div className={activeTestimonial === 2 ? "active" : ""} onClick={() => handleTestimonialClick(2)}>
                          <div className="thumb">
                            <div className="row">
                              <div className="col-lg-4 col-sm-4 col-12">
                                <h4>May Catherina</h4>
                        ...
                        <div className={activeTestimonial === 3 ? "active" : ""} onClick={() => handleTestimonialClick(3)}>
                          <div className="thumb">
                            <div className="row">
                              <div className="col-lg-4 col-sm-4 col-12">
                                <h4>Random User</h4>
                        ...
                        <div className={activeTestimonial === 4 ? "last-thumb active" : "last-thumb"} onClick={() => handleTestimonialClick(4)}>
                          <div className="thumb">
                            <div className="row">
                              <div className="col-lg-4 col-sm-4 col-12">
                                <h4>Mark Amber Do</h4>
